...
$(document).on("click", "#button", function(e) {
    ...
    if (btnType == "park") {
        ...
        if (currentType == 'garages') {
            $.post("http://bb-garages/payout", JSON.stringify({
                garage: activeGarage,
        ...
        $.post("http://bb-garages/waypoint", JSON.stringify({
            name: btnName,
            type: btnType,
        }));
        ...
        setTimeout(() => {
            ...
            $.post("http://bb-garages/vehicleblip", JSON.stringify({
                plate: btnPlate,
            }));
        }, 2000);
    }
